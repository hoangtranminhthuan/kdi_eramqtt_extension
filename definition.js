...
Blockly.Python['yolobit_mqtt_connect_wifi'] = function(block) {
  Blockly.Python.definitions_['import_mqtt'] = 'from mqtt_era import *';
...
Blockly.Blocks['yolobit_mqtt_publish_value'] = {
  init: function() {
    // Tự động tạo danh sách các chân ảo từ V0 đến V499
    var pinOptions = [];
    for (var i = 0; i <= 499; i++) {
      pinOptions.push(['V' + i, String(i)]);
    }
    ...
    this.setNextStatement(true);
    this.setColour(230);
    this.setTooltip('Gửi giá trị lên Virtual pin Vn');
    this.setHelpUrl('');
  }
};
